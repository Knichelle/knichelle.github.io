...
// Base game variables
const frameRate = 60;
const playerScale = 0.85; //makes the player just a bit smaller. Doesn't affect the hitbox, just the image
...
var platformsList = {
  longPlatform: { image: "images/platforms/long-platform.png"},
  tinyPlatform: { image: "images/platforms/tiny-platform.png"},
};